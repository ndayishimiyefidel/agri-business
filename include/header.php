            ...
            <div class="container">
                <ul class="header-links pull-left">
                    ...
                    <li><a href="https://goo.gl/maps/YLavb8bzF8Wm6TRLA"><i class="fa fa-map-marker"></i> Eglise
                            Rwanda, Kicukiro District</a></li>
                </ul>
                <ul class="header-links pull-right">
                    <li><a href="#"><i class="fa fa-money"></i> RWF </a></li>
                    <?php
                    if (!isset($_SESSION['isCustomerLoggedIn'])) { ?>
                    <li><a href="./Inventory/index.php" style="color:#F35202;"><i class="fa fa-product-hunt"></i>Sell
                            Your
                            Item
                        </a></li>
                    <?php
                    ...
                    ?><li><a href="myorder.php"><i class=" fa fa-first-order" aria-hidden="true"></i>
                            My
                            order</a></li>
                    <strong style="color:white;"><?php echo $lname; ?> </strong>
                                ...
                                <div class="cart-dropdown">
                                    ...
                                    <?php
                                            ...
                                            if (!empty($_SESSION['cart'])) {
                                                //check whether the cart session not expired
                                                $timenow = time();
                                                if ($timenow > $_SESSION['expire_time']) //set cart expiration in one time
                                                {
                                    ...
                                    <div class="product-widget">
                                        ...
                                        <div class="product-body">
                                            <h3 class="product-name"><a href="#"><?= $row['product_name'] ?>&nbsp;type
                                                    of&nbsp;
                                                    <?= $row['pro_category'] ?></a>
                                            </h3>
                                            <h4 class="product-price"><span
