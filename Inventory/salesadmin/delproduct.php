...
if (isset($_GET['id'])) {
    ...
    $myhist = "INSERT INTO `tbl_history`(`hist_id`, `id`,`pr_id`, `product_name`, `pro_category`, `season`, `unit_price`, `qty`, `discount`, `action_date`, `action_happened`) VALUES (null,'$user_id','$row_id','$pr_name','$categor','$season','$price','$qty','$disc','$date','$act_happened')";
    $runhist = mysqli_query($connection, $myhist);

    $query = "DELETE FROM products WHERE pr_id =$id and id='$user_id'";
