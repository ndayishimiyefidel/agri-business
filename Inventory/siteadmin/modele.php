...
class Model
{
    ...
    FROM
        ...
        orders
    WHERE
        orders.customer_id = customers.customer_id AND orders.pr_id = products.pr_id AND orders.status = 'Received'";
...
FROM
    ...
    orders
WHERE
    orders.customer_id = customers.customer_id AND orders.pr_id = products.pr_id AND orders.order_date > '$start_date' AND orders.order_date < '$end_date'
