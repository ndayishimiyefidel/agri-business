         ...
         <div class="row">
                 ...
                 <div class="aside">
                     ...
                     <div class="checkbox-filter">
                         <?php
                            ...
                            $query = "SELECT  DISTINCT (pro_category) FROM products";
                         ...
                         <div class="input-checkbox">
                             <input type="checkbox" id="category-<?= $k ?>">
             ...
             <div id="store" class="col-md-9">
                 ...
                 <?php $recordcount = 0;
                    ...
                    $total_pages_sql = "SELECT COUNT(*) FROM products where pro_category='$category'";
                    ...
                    ?> <div class="row">
                     <?php
                        $query = "SELECT  * FROM products  where pro_category='$category' ORDER BY add_date ASC LIMIT $offset, $no_of_records_per_page";
                        $sql = mysqli_query($connection, $query);
                     ...
                     <ul class="store-pagination">
                         <li class="<?php if ($pageno <= 1) {
                                 ...
                                 <?php if ($pageno <= 1) {
                                        ...
                                        echo "single_category.php?pageno=" . ($pageno - 1);
                                    } ?> ">
                        ...
                        ?>
                         <li class="">
                             <a href="single_category.php?pageno=<?= $i ?>"><?= $i ?></a>
                         </li>
                         <?php } ?>
